...
layers = [
    ...
    lstmLayer(numHiddenUnits, 'OutputMode', 'sequence', 'Name', 'lstm2') % Add a new lstm layer
    batchNormalizationLayer('Name','bn2')
    lstmLayer(numHiddenUnits, 'OutputMode','last', 'Name','lstm3') % Make the last lstm layer output only the last sequence
